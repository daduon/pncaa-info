                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="title" style="margin-left: 70px;">
                                <strong style="font-size: 20px;">Update Content Contact</strong>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <form id="form-contact" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" value="{{ $contact->id }}" id="id">
                                            <input type="text" value="{{ $contact->banner_title }}" id="banner_title"
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $contact->banner_sub_title }}"
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $contact->title }}" id="title"
                                    ...
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $contact->sub_title }}" id="sub_title"
                                ...
                                <div class="row mt-2">
                                    <div class="col">
                                        <img id="image-preview" src="{{ $contact->banner_image }}" alt="your image"
                                            width="200" height="100" />
                                        <input type="hidden" value="{{ $contact->banner_image }}" id="get-image">
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col">
